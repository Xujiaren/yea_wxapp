...
class registInfo extends Component<{}, PageState>  {
    ...
    _onSubmit(){
        var that = this;
        const {PostCard,Card,NickName,Age,IdCard,Phone,Address,addressId,Email,activityId} = that.state;
        ...
        if(isPush){
            api.post(inter.ActivityLine + activityId,{
                username:NickName,
                sn:Card,
                age:Age,
                identitySn:IdCard,
    ...
    render () {
        const {PostCard,adres,show_pannel,sexList,sexIndex,NickName,Card,Age,IdCard,Phone,Address,Email,} = this.state

        return (
            <View className='root'>
                <View className='apply_type'></View>
                <View className='form mb_50'>
                    ...
                    <View className='form_item d_flex ai_ct jc_sb' >
                        ...
                        <Input className='input default_label tip_label col_1'
                            ...
                            placeholderClass='p_color'
                            value={Card}
                            onInput={(e)=>this.setState({Card:e.detail.value})}
                        />
                    </View>
                    <View className='form_item d_flex ai_ct jc_sb'>
                        ...
                        <View className='picker_wrap'>
                            <Picker
                                ...
                                mode='selector'
                                range={sexList}
                                onChange={(e)=>this.setState({sexIndex:e.detail.value})}
                            >
                                <View className="d_flex row ai_ct col_1 jc_fe ">
                                    <Text className='default_label tip_label mt_2'>{sexList[sexIndex]}</Text>
                    ...
                    <View className='form_item d_flex ai_ct jc_sb' >
                        ...
                        {
                            Card !== '' ?
                            <Text className='default_label tip_label mt_2 pr_30'>{PostCard === 0 ? '正卡' : '副卡'}</Text>
                        :
                            <Text className='default_label tip_label mt_2 pr_30'>{'无'}</Text>
                        }
                    </View>
                    <View className='form_item d_flex ai_ct jc_sb' >
                    ...
                    <View className='form_item d_flex ai_ct jc_sb' >
                        ...
                        <Input className='input default_label tip_label col_1 pl_30'
                            placeholder='请输入邮箱'
                            type='text'
                            placeholderClass='p_color'
                            value={Email}
...
export default registInfo as ComponentClass
